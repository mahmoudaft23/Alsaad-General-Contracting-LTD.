<div id="modal-add" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content back1-1">
            <form action="add-client-form.php" method="post" id="add-form">
                <div class="model-header column-gap-0 position-relative">
                    ...
                    <h4 class="px-4 py-3" style="color: white;">Add clients</h4>
                ...
                <div class="modal-body px-3">
                    ...
                    <div class="despli1-1">
                        <div >
                            ...
                            <input class="in1-1" type="text" id="ClientID" name="ClientID" style="color: white;">
                        </div>
                        <div  style="margin-left: 40px;">
                            <label for="Name" style="color: white;">Name:</label><br>
                            <input class="in1-1" type="text" id="Name" name="Name" style="color: white;">
                        </div>
                    </div>
                    ...
                    <div class="despli1-1" style="margin-top: 30px;">
                        <div >
                            ...
                            <input class="in1-1" type="text" id="EngineerID" name="EngineerID" style="color: white;">
                        </div>
                        <div  style="margin-left: 40px;">
                            <label for="Stat" style="color: white;">Stat:</label><br>
                            <input class="in1-1" type="text" id="Stat" name="Stat" style="color: white;">
                        </div>
                    </div>
                    <div style="margin-left: 65px; margin-right: 60px; margin-top: 30px;" class="despli1-2">
                        ...
                        <input class="in1-2" type="text" id="Password" name="Password" style="width: 100%; color: white;" >
                ...
                <div class="modal-footer justify-content-center d1-1">
                    ...
                    <div style="margin-left: 100px;">
                        ...
                        <button class="button2" id="submit-btn1" type="submit">Add</button>
                    </div>
...
<script>
    ...
    form.addEventListener('submit', (event) => {
        ...
        // xhr.send(formData);
        xhr.open("POST", "add-client-form.php");
        xhr.onload = function() {
            if (xhr.status === 200) {
