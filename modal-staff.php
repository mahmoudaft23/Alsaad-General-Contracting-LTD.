<div id="modal-edit" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content back1-1">
            <form action="/edit-staff-form.php" method="post" id="edit-form">
            <div class="model-header column-gap-0 position-relative">
                ...
                <h4 class="px-4 py-3" style="color: white;">Edit Staff</h4>
            ...
            <div class="modal-body px-3">
                    <div class="despli1-1">
                        <div >
                            ...
                            <input class="in1-1" type="text" id="Staff_ID" name="Staff_ID" style="color: white;" value="<?php echo $_SESSION["selected_card_id"] ?>">
                        </div>
                        <div  style="margin-left: 40px;">
                            <label for="Staff_Name" style="color: white;">Name:</label><br>
                            <input class="in1-1" type="text" id="Staff_Name" name="Staff_Name" style="color: white;"value="<?php echo $_SESSION["selected_card_name"] ?>">
                        </div>
                    </div>
                    ...
                    <div style="margin-left: 65px; margin-right: 60px;" class="despli1-2">
                        ...
                        <input class="in1-2" type="text" id="Staff_Engineer_ID" name="Staff_Engineer_ID" style="width: 100%; color: white;"value="<?php echo $_SESSION["engineer_id"] ?>" >
                    ...
                    <div style="margin-left: 65px; margin-right: 60px; margin-top: 30px;" class="despli1-2">
                        ...
                        <input class="in1-2" type="text" id="Location" name="Location" style="width: 100%; color: white;"value="<?php echo $_SESSION["location"] ?>" >
...
<script>
    ...
    form.addEventListener('submit', (event) => {
        ...
        // xhr.send(formData);
        xhr.open("POST", "edit-staff-form.php");
        xhr.onload = function() {
            if (xhr.status === 200) {
