<div id="modal-add" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content back1-1">
            <form action="add-project-form.php" method="post" id="add-form">
                ...
                <div class="modal-body px-3">
                    ...
                    <div class="despli1-1">
                        <div >
                            ...
                            <input class="in1-1" type="text" id="ProjectID" name="ProjectID" style="color: white;">
                        </div>
                        <div  style="margin-left: 40px;">
                            <label for="ProjectName" style="color: white;">ProjectName:</label><br>
                            <input class="in1-1" type="text" id="ProjectName" name="ProjectName" style="color: white;">
                        </div>
                    </div>
                    ...
                    <div style="margin-left: 65px; margin-right: 60px;" class="despli1-2">
                        ...
                        <input class="in1-2" type="text" id="Description" name="Description" style="width: 100%;color: white;">

                    </div>
                    <div class="despli1-1" style=" margin-top: 30px;">
                        <div >
                            <label for="Start_Date" style="color: white;">Start_Date</label><br>
                            <input class="in1-1" type="date" id="Start_Date" name="Start_Date" style="color: white;">
                        </div>
                        <div  style="margin-left: 40px;">
                            <label for="PEnd_Date" style="color: white;">PEnd_Date:</label><br>
                            <input class="in1-1" type="date" id="PEnd_Date" name="PEnd_Date" style="color: white;">
                        </div>
                    </div>
                    ...
                    <div style="margin-left: 65px; margin-right: 60px; margin-top: 30px;" class="despli1-2">
                        ...
                        <input class="in1-2" type="text" id="EngineerID" name="EngineerID" style="width: 100%; color: white;">

                    </div>
                    <div class="despli1-1"  style=" margin-top: 30px;">
                        <div >
                            <label for="Client_D" style="color: white;">Client_D:</label><br>
                            <input class="in1-1" type="text" id="Client_D" name="Client_D" style="color: white;">
                        </div>
                        <div  style="margin-left: 40px;">
                            <label for="Location" style="color: white;">Location:</label><br>
                            <input class="in1-1" type="text" id="Location" name="Location" style="color: white;">
                        </div>
                    </div>
                    ...
                    <div style="margin-left: 65px; margin-right: 60px; margin-top: 30px;" class="despli1-2">
                        ...
                        <input class="in1-2" type="text" id="Scope" name="Scope" style="width: 100%; color: white;">

                    </div>
                    <div class="despli1-1" style=" margin-top: 30px;">
                        <div >
                            <label for="PlotArea" style="color: white;">PlotArea:</label><br>
                            <input class="in1-1" type="text" id="PlotArea" name="PlotArea" style="color: white;">
                        </div>
                        <div  style="margin-left: 40px;">
                            <label for="Built-Up_Area" style="color: white;">Built-Up_Area:</label><br>
                            <input class="in1-1" type="text" id="Built-Up_Area" name="Built-Up_Area" style="color: white;">
                        </div>
                    </div>
                    <br>
...
<script>
    ...
    form.addEventListener('submit', (event) => {
        ...
        // xhr.send(formData);
        xhr.open("POST", "add-project-form.php");
        xhr.onload = function() {
            if (xhr.status === 200) {
